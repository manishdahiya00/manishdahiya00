...
[![My Skills](https://skills.thijs.gg/icons?i=html,css,js,ts,tailwindcss,react,redux,nextjs,nodejs,expressjs,mysql,mongodb,postgres,py,firebase,appwrite,github,git,figma,rubyonrails&theme=light)](https://skills.thijs.gg)
#
## 🎉 Github Stats
